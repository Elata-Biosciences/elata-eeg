...
pub const CONFIG1_ADDR: u8 = 0x01;
pub const CONFIG1_REG: u8 = 0x90;
pub const CONFIG2_ADDR: u8 = 0x02;
pub const CONFIG2_REG: u8 = 0xC0;
pub const CONFIG3_ADDR: u8 = 0x03;
pub const CONFIG3_REG: u8 = 0x60;
pub const LOFF_ADDR: u8 = 0x04;
pub const CH1SET_ADDR: u8 = 0x05;
pub const CHN_REG: u8 = 0x00;
pub const CHN_OFF: u8 = 0x00 | POWER_OFF_CH;
pub const BIAS_SENSP_ADDR: u8 = 0x0D;
pub const BIAS_SENSP_REG: u8 = BIAS_SENS_OFF_MASK;
pub const BIAS_SENSN_ADDR: u8 = 0x0E;
pub const BIAS_SENSN_REG: u8 = 0x00;
pub const LOFF_SENSP_ADDR: u8 = 0x0F;
pub const LOFF_SESP_REG: u8 = 0x00;
pub const MISC1_ADDR: u8 = 0x15;
pub const MISC1_REG: u8 = 0x00;
pub const CONFIG4_ADDR: u8 = 0x17;
pub const CONFIG4_REG: u8 = 0x00;
...
pub fn gain_to_reg_mask(gain: f32) -> Result<u8, crate::types::DriverError> {
    match gain as u8 {
        ...
        12 => Ok(5 << 4),
        24 => Ok(6 << 4),
        _ => Err(crate::types::DriverError::ConfigurationError(format!(
            "Unsupported gain: {}. Supported gains: 1, 2, 4, 6, 8, 12, 24",
            gain
        ))),
    }
}
